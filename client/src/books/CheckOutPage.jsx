...
const CheckOutPage = () => {
    const currentUser = true; // TODO : get user from auth context 
                                ...
                                <div className="lg:col-span-2">
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        <div className="md:col-span-5">
                                            ...
                                            <input className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" {...register("name", { required: true })} type="text" id="name" />
                                        </div>
                                        ...
                                        <div className="md:col-span-5">
                                            ...
                                            <input
                                                {...register("phone", { required: true })} type="number" id="phone" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="+123 456 7890" />
                                        </div>
                                        ...
                                        <div className="md:col-span-5 text-right">
                                            <div className="inline-flex items-end">
                                                <button type='submit'
                                                    disabled={!isChecked}
                                                    className={`bg-blue-500 text-white font-bold py-2 px-4 rounded ${!isChecked ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'
                                                        }`}>
                                                    Place an Order
                                                </button>
